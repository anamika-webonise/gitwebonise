	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnHelp.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				// Create the adView
				AdView adView = new AdView(RajaMantri.this, AdSize.BANNER,
						"a14e156523d01de");
					...
					public void onClick(View v) {
						...
						if (player1_name.equals("") || player2_name.equals("")
							...
							Toast toast = Toast.makeText(getBaseContext(),
									"Enter player names!", 8000);
							toast.show();
						} else {
							setContentView(R.layout.rmcsgnew);
							// Create the adView
							AdView adView = new AdView(RajaMantri.this,
									AdSize.BANNER, "a14e156523d01de");
							// Lookup your LinearLayout assuming it’s been given
							// the attribute android:id="@+id/mainLayout"
